package id.ac.atmaluhur.crudmysql
...
class EntriAlumniActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = "${if(!modeEdit) "Tambah" else "Ubah"} Data Alumni"
        ...
        btnSimpan.setOnClickListener {
            ...
            rq = Volley.newRequestQueue(this@EntriAlumniActivity)
            rq.add(sr)
        }
    }
